	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					...
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.kouwei" placeholder="口味"
								clearable>
							</el-input>
						</div>
					</div>
			...
			<el-table
				...
				<el-table-column label="菜品图片" width="120" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
...
<script setup>
	...
	const getList = () => {
		...
		if(searchQuery.value.kouwei&&searchQuery.value.kouwei!=''){
			params['kouwei'] = '%' + searchQuery.value.kouwei + '%'
		}
		context?.$http({
			url: `${tableName}/page`,
			method: 'get',
